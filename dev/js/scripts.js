...
function layerthree(){
    ...
    tl.to("#ca1",{morphSVG:"#ca2",duration:.2},"playSameTime");
    tl.to("#cb1",{morphSVG:"#cb2",duration:.2},"playSameTime");
    tl.to("#cc1",{morphSVG:"#cc2",duration:.2},"playSameTime");
    tl.to("#cd1",{morphSVG:"#cd2",duration:.2},"playSameTime");
    tl.to("#ce1",{morphSVG:"#ce2",duration:.2},"playSameTime");
...
function layerfour(){
    ...
    tl.to("#ca2",{morphSVG:"#ca3",duration:.2},"playSameTime");
    tl.to("#cb2",{morphSVG:"#cb3",duration:.2},"playSameTime");
    tl.to("#cc2",{morphSVG:"#cc3",duration:.2},"playSameTime");
    tl.to("#cd2",{morphSVG:"#cd3",duration:.2},"playSameTime");
    tl.to("#ce2",{morphSVG:"#cb3",duration:.2},"playSameTime");
...
function layerfive(){
    ...
    tl.to("#ca3",{morphSVG:"#cb4",duration:.2},"playSameTime");
    tl.to("#cb3",{morphSVG:"#cc4",duration:.2},"playSameTime");
    tl.to("#cc3",{morphSVG:"#ca4",duration:.2},"playSameTime");
    tl.to("#cd3",{morphSVG:"#cd4",duration:.2},"playSameTime");
    tl.to("#ce3",{morphSVG:"#cc4",duration:.2},"playSameTime");
...
function layersix(){
    ...
    tl.to("#cb4",{morphSVG:"#cb5",duration:.2},"playSameTime");
    tl.to("#cc4",{morphSVG:"#cc5",duration:.2},"playSameTime");
    tl.to("#ca4",{morphSVG:"#ca5",duration:.2},"playSameTime");
    tl.to("#cd4",{morphSVG:"#cd5",duration:.2},"playSameTime");
...
function layerseven(){
    ...
    tl.from("#st1",{opacity:0, duration:.2, y:"1000"},"playSameTime")
    tl.to("#cb5",{morphSVG:"#cb6",duration:.2},"playSameTime");
    tl.to("#cc5",{morphSVG:"#cc6",duration:.2},"playSameTime");
    tl.to("#ca5",{morphSVG:"#ca6",duration:.2},"playSameTime");
    tl.to("#cd5",{morphSVG:"#cd6",duration:.2},"playSameTime");
